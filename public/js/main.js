...
var Panel = function (_React$Component) {
	...
	function Panel(props) {
		...
		_this.state = {
			days: [{ date: '15. červen 2016', ico: '01d', temperature: '24°' }, { date: '16. červen 2016', ico: '02d', temperature: '23°' }, { date: '17. červen 2016', ico: '03d', temperature: '22°' }, { date: '18. červen 2016', ico: '04d', temperature: '21°' }, { date: '19. červen 2016', ico: '09d', temperature: '20°' }]
		};
		return _this;
	}
	...
	_createClass(Panel, [{
		...
		value: function render() {
			...
			for (var i = 1; i < 5; i++) {
				...
				rows.push(React.createElement(
					...
					React.createElement(
						'td',
						null,
						React.createElement('img', { src: 'http://openweathermap.org/img/w/' + day[i].ico + '.png', style: { width: 32, height: 32 } })
					),
					React.createElement(
						'td',
			...
			return React.createElement(
				'div',
				{ className: 'panel panel-default col-md-3', style: { padding: 0 } },
				React.createElement(
					'div',
					{ style: { backgroundColor: this.props.color, color: '#FFFFFF', padding: 5 } },
					React.createElement(
						'h4',
						null,
						this.props.city
					...
					React.createElement(
						...
						React.createElement(
							'h1',
							{ style: { margin: 0 } },
							React.createElement('img', { src: 'http://openweathermap.org/img/w/' + day[0].ico + '.png', style: { width: 72, height: 72 } }),
							day[0].temperature
						)
					)
				),
...
},{"../services/httpservice.jsx":171,"react":167}],170:[function(require,module,exports){
'use strict';
...
ReactDOM.render(React.createElement(Panel, { color: '#CC0000', city: 'Cesky Krumlov' }), document.getElementById('main'));

},{"./components/Panel.jsx":169,"react":167,"react-dom":29}],171:[function(require,module,exports){
'use strict';

var Fetch = require('whatwg-fetch');

var service = {
	get: function get(city) {
		return fetch('http://api.openweathermap.org/data/2.5/forecast/city?q=' + city + '&APPID=e09581cfda14c3ac23a563e2e5adf3b6').then(function (response) {
